...
names(taula) = gsub('.', ':', names(taula), fixed = T)

colnames(taula)[which(colnames(taula) == 'DA:pERK1:2')] = 'DA:pERK1/2'
colnames(taula)[which(colnames(taula) == 'DV:pERK1:2')] = 'DV:pERK1/2'
